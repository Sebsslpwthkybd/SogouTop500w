...
* --jars /home/hd/apps/spark/jars/mysql-connector-java-8.0.22.jar
* /home/hd/data/sogou-1.0-SNAPSHOT.jar
*
* */
object Q1_SogouToMySQL {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //进行查询
    val res = sparkSession.sql("select keyword,count(*) as query_count from t_sogou  group by keyword order by query_count desc limit 50;");
    //手动创建数据库  create database person character set utf8;
    val url="jdbc:mysql://192.168.75.129:3306/sogou?useUnicode=true&characterEncoding=utf-8&relaxAutoCommit=true&zeroDateTimeBehavior=convertToNull&allowMultiQueries=true";
    val table ="sogou_Q1";
